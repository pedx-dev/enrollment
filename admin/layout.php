    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 sidebar-bg transform -translate-x-full lg:static lg:translate-x-0 transition-transform duration-300 overflow-y-auto">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-lg font-bold" style="color: #222431;">Enrollment</h1>
        ...
        <nav class="p-4 space-y-2">
            <a href="<?php echo SITE_URL; ?>/admin/dashboard.php" class="nav-link flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 transition" style="color: #222431;">
                <i class="fas fa-chart-line w-5"></i>
                <span class="font-medium">Dashboard</span>
            </a>

            <a href="<?php echo SITE_URL; ?>/admin/enrollment.php" class="nav-link flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 transition" style="color: #222431;">
                <i class="fas fa-user-plus w-5"></i>
                <span class="font-medium">New Enrollment</span>
            </a>

            <a href="<?php echo SITE_URL; ?>/admin/students.php" class="nav-link flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 transition" style="color: #222431;">
                <i class="fas fa-users w-5"></i>
                <span class="font-medium">Students</span>
            </a>

            <a href="<?php echo SITE_URL; ?>/admin/courses.php" class="nav-link flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 transition" style="color: #222431;">
                <i class="fas fa-book w-5"></i>
                <span class="font-medium">Courses</span>
            </a>

            <a href="<?php echo SITE_URL; ?>/admin/teachers.php" class="nav-link flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 transition" style="color: #222431;">
            ...
            <a href="<?php echo SITE_URL; ?>/admin/settings.php" class="nav-link flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-100 transition" style="color: #222431;">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="hidden sm:block">
                        ...
                        <p class="text-xs text-gray-300 capitalize"><?php echo htmlspecialchars($user_role); ?></p>
                    </div>
                </div>
